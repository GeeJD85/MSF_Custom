...
namespace GW.Master
{
    public class AccountsDatabase_Accessor : IAccountsDatabaseAccessor
    {
        ...
        //True means value must be unique
        public AccountsDatabase_Accessor(LiteDatabase database)
        {
        ...
        {
            //Delete the old recovery code first
        ...
        {
            //Delete the old confirmation code first
